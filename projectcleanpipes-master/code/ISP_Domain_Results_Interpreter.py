...
class ISP_Domain_Results_Interpreter:
    ...
    def __init__(self, name, ISP, ALL_ISP_LIST, domain_response_codes, default_DNS_response_codes, public_DNS_response_codes, list_of_domains):
        ...
        self.allDomainResponseCodes = self.dictOfAllDomainsOfAllISPs("data\CopyRight_Telstra.txt", "Response Code")
        self.allPublicDNSResponseCodes = self.dictOfAllDomainsOfAllISPs("data\CopyRight_Telstra.txt", "Response Code Public DNS")
        self.defaultDNSResponseCodes = self.dictOfAllDomainsOfAllISPs("data\CopyRight_Telstra.txt", "Response Code Default DNS")

        self.allBlockPages = self.dictOfAllDomainsOfAllISPs("data\CopyRight_Telstra.txt", "Block Page")
        self.allPuclicDNSBlockPages = self.dictOfAllDomainsOfAllISPs("data\CopyRight_Telstra.txt", "Block Page Public DNS")
        self.defaultDNSBlockPages = self.dictOfAllDomainsOfAllISPs("data\CopyRight_Telstra.txt", "Block Page Default DNS")

        self.allCloudFlareBlockPages = self.dictOfAllDomainsOfAllISPs("data\CopyRight_Telstra.txt", "Cloudflare Block Page")
        self.allPuclicDNSCloudFlareBlockPages = self.dictOfAllDomainsOfAllISPs("data\CopyRight_Telstra.txt", "Cloudflare Block Page Public DNS")
        self.defaultDNSCloudFlareBlockPages = self.dictOfAllDomainsOfAllISPs("data\CopyRight_Telstra.txt", "Cloudflare Block Page Default DNS")
        ...
        for name in self.list_of_domains:
            ...
            for isp in self.All_ISPs:
                ...
                if reason == "Response Code":
                    dictionaryOfDomains[name][isp.name] = "Response Code"
                elif reason == "Block Page":
                    dictionaryOfDomains[name][isp.name] = "Block Page"
                elif reason == "Cloudflare Block Page":
                    dictionaryOfDomains[name][isp.name] = "Cloudflare Block Page"
                elif reason == "Response Code Public DNS":
                    dictionaryOfDomains[name][isp.name] = "Response Code Public DNS"
                elif reason == "Block Page Public DNS":
                    dictionaryOfDomains[name][isp.name] = "Block Page Public DNS"
                elif reason == "Cloudflare Block Page Public DNS":
                    dictionaryOfDomains[name][isp.name] = "Cloudflare Block Page Public DNS"
                elif reason == "Response Code Default DNS":
                    dictionaryOfDomains[name][isp.name] = "Response Code Default DNS"
                elif reason == "Block Page Default DNS":
                    dictionaryOfDomains[name][isp.name] = "Block Page Default DNS"
                elif reason == "Cloudflare Block Page Default DNS":
                    dictionaryOfDomains[name][isp.name] = "Cloudflare Block Page Default DNS"
                else:
